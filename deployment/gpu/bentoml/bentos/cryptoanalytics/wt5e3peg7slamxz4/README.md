# cryptoanalytics:wt5e3peg7slamxz4

[![pypi_status](https://img.shields.io/badge/BentoML-1.1.7-informational)](https://pypi.org/project/BentoML)
...
| ------------ | ----- | ------ |
| POST [`/cryptoanalytics`](#operations-Service_APIs-cryptoanalytics__cryptoanalytics) | JSON | NumpyNdarray |
